...
public abstract class V2SourceStampSigner {
	...
	throws SignatureException, NoSuchAlgorithmException, InvalidKeyException {
		...
		Collections.sort(signatureSchemeDigests, new Comparator<Pair>() {
				@Override
				public int compare(Pair p1, Pair p2) {
					return ((Integer) p1.getFirst()).compareTo((Integer) p2.getFirst());
				}
			});
	...
	throws NoSuchAlgorithmException, InvalidKeyException, SignatureException {
		...
		Collections.sort(digests, new Comparator<Pair>() {
				@Override
				public int compare(Pair p1, Pair p2) {
					return ((Integer) p1.getFirst()).compareTo((Integer) p2.getFirst());
				}
